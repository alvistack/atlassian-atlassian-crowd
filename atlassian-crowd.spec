...
install -Dpm644 -t %{buildroot}/opt/atlassian/crowd atlassian-crowd.patch
...
CROWD_DOWNLOAD_URL=http://product-downloads.atlassian.com/software/crowd/downloads/atlassian-crowd-5.0.2
tar.gz
...
/opt/atlassian/crowd/atlassian-crowd.patch
